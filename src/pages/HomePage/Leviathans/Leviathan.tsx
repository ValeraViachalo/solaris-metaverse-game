...
const Leviathan = () => {
  ...
  return (
    <section id="leviathan">
      ...
      >
        <h1 className="big-text leviathan__title">
          «Leviathan.»
        </h1>

        <div className="leviathan__text">
          <h2 className="leviathan__text_title">
            A common quest for all explorers of the Solaris universe.
          </h2>
          <p className="leviathan__text_sub_title">
            The first explorer to reach the center of the universe will instantly receive a $100,000 credit to their authorized Metamask wallet. After which, we will contact you to arrange an interview at a location most convenient for you. (Boston, Los Angeles, or Western Europe) 
          </p>
        </div>

      <div className="leviathan__body">
        <img ref={el => leviathanRef.current.push(el!)} src={leviathan1} alt="leviathan-1" className="leviathan__body_image leviathan__body_image--1" />
      </div>

      <div className="leviathan__body">
        <img ref={el => leviathanRef.current.push(el!)} src={leviathan2} alt="leviathan-2" className="leviathan__body_image leviathan__body_image--2" />
      </div>
      <div className="leviathan__body">
        <img ref={el => leviathanRef.current.push(el!)} src={leviathan3} alt="leviathan-3" className="leviathan__body_image leviathan__body_image--3" />
      </div>
      <div className="leviathan__body">
        <img ref={el => leviathanRef.current.push(el!)} src={leviathan4} alt="leviathan-4" className="leviathan__body_image leviathan__body_image--4" />
      </div>
      <div className="leviathan__body">
        <img ref={el => leviathanRef.current.push(el!)} src={leviathan5} alt="leviathan-5" className="leviathan__body_image leviathan__body_image--5" />
      </div>
        ...
        <ul className="leviathan__links footer__links">
          {FooterLinks.map((curentLink, i) => {
            ...
            return (
              <li key={i}>
                <a href={link} className="leviathan__bottom_link">
                  {title}
                </a>
              </li>
            )
