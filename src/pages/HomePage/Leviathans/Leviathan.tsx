...
const Leviathan = () => {
  ...
  return (
    <section id="leviathan">
      ...
      >
        <h1 className="big-text leviathan__title">«Leviathan.»</h1>
        ...
        <div className="leviathan__text">
          ...
          <p className="leviathan__text_sub_title">
            The first explorer to reach the center of the universe will
            instantly receive a $100,000 credit to their authorized Metamask
            wallet. After which, we will contact you to arrange an interview at
            a location most convenient for you. (Boston, Los Angeles, or Western
            Europe)
          </p>
        </div>
